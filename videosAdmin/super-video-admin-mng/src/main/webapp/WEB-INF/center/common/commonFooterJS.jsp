...
<input type="hidden" id="apiServer" name="apiServer" value="http://172.16.7.43:8081"/> 
<input type="hidden" id="bgmServer" name="bgmServer" value="http://172.16.7.43:8080/mvc"/>
